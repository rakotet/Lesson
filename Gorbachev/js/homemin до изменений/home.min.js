...
let count = 1;
let position = 0;
let objYearLength = {1985: 0, 1986: 0, 1987: 0, 1988: 0, 1989: 0, 1990: 0, 1991: 0};
let objYearCount = {1985: 0, 1986: 0, 1987: 0, 1988: 0, 1989: 0, 1990: 0, 1991: 0};
...
let click1986 = document.querySelector(".four-year-list .four-year:nth-child(3)");
let click1987 = document.querySelector(".four-year-list .four-year:nth-child(7)");
...
let widthBook = 408 - 408 * .05;
let heightBook = 552 - 552 * .05;
let distanceBook = 270 - 270 * .05;
...
if (currentBook < 1690 && currentBook > 1425) {
    distanceBook = 246 - 246 * .05
} else if (currentBook < 1425 && currentBook > 1190) {
    distanceBook = 196 - 196 * .05
...
var carouselSix = $("#carousel").waterwheelCarousel({
    ...
    imageNav: true,
    preloadImages: true,
    forcedImageWidth: widthBook,
    forcedImageHeight: heightBook,
    movingToCenter: $.noop,
    movedToCenter: $.noop,
    clickedCenter: $.noop,
...
if (Number(window.innerWidth) > 1e3) {
...
var carouselSeven = $("#carousel-photo").waterwheelCarousel({
    ...
    imageNav: false,
    preloadImages: true,
    forcedImageWidth: widthSeven,
    forcedImageHeight: heightSeven,
    movingToCenter: $.noop,
    movedToCenter: $.noop,
    clickedCenter: $.noop,
    movingFromCenter: $.noop,
...
eightVideo.width = Number(widthEight) + Number(widthEight) * .06;
eightVideo.height = Number(heightEight) + Number(heightEight) * .06;
var carouselEight = $("#carousel-eight").waterwheelCarousel({
    startingItem: 1,
    separation: distanceEight,
    separationMultiplier: .8,
    horizonOffset: 0,
    horizonOffsetMultiplier: 1,
    sizeMultiplier: .8,
    ...
    imageNav: false,
    preloadImages: true,
    forcedImageWidth: widthEight,
    forcedImageHeight: heightEight,
    movingToCenter: $.noop,
    movedToCenter: $.noop,
    clickedCenter: $.noop,
    movingFromCenter: $.noop,
