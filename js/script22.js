...
//Сначала свойства ищутся у объекта, если нужного свойства нет, оно ищится у прототипа объекта
...
console.log(ford.getAge())// все методы прототипа объекта есть и у самого объекта
