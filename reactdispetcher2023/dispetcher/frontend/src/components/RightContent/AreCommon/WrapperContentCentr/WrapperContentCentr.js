...
export default function WrapperContentCentr({label = '', actionLk, count = '', companyCardOpenHide, setDispCardEdit, backDisp ='', showMoreActiv='', trashDisp, refreshData='', setUploadingData, margin = false, clickAuto, arrAssign, dispCardEditNoUpdatePage, sort='', switchArrow = {arrow: ''}, setDataExcel = () => {}}) {
  ...
  function getDataUnloading() {
    if(actionLk == actionLkUnloading.getGroupData) {
      return <GroupUnloadingData data={arrGroup} count={count} companyCardOpenHide={companyCardOpenHide} setDispCardEdit={setDispCardEdit} trashDisp={trashDisp} sort={sort} switchArrow={switchArrow} setDataExcel={setDataExcel}/>
    } else if(actionLk == actionLkUnloading.getDispData) {
      return <DispUnloadingData data={arrGroup} count={count} dispCardOpenHide={companyCardOpenHide} setDispCardEdit={setDispCardEdit} trashDisp={trashDisp} sort={sort} switchArrow={switchArrow} setDataExcel={setDataExcel}/>
    } else if(actionLk == actionLkUnloading.getAutoData) {
      return <AutoUnloadingData data={arrGroup} count={count} dispCardOpenHide={companyCardOpenHide} setDispCardEdit={setDispCardEdit} trashDisp={trashDisp} sort={sort} switchArrow={switchArrow} setDataExcel={setDataExcel}/>
    } else if(actionLk == actionLkUnloading.getApplicationsData) {
      return <ApplicationsUnloadingData data={arrGroup} count={count} dispCardOpenHide={companyCardOpenHide} setDispCardEdit={setDispCardEdit} setUploadingData={setUploadingData} sort={sort} switchArrow={switchArrow} setDataExcel={setDataExcel}/>
