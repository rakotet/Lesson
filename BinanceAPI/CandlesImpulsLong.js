...
const bezubitokBuy = 0.006 // % безубытка
...
async function priceSymbolPamp(symbol, fs) {
  ...
  try {
    ...
    if(true /*&& (oneOpen > oneClose) && (twoOpen > twoClose) && (twoLow > f20) && (oneLow > f20) && (oneClose >= f8) && (((((oneClose - f20) / f20) * 100)) > plusProfitPercent)
